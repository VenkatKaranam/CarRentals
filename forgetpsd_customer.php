...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="div1">
                <div class="modal">
                    <h3 class="title color_white">CUSTOMER FORGET PASSWORD</h3>
                    <p id="warn"></p>
                    <?php 
                    ...
                    ?>
                    <form  name="form" onsubmit="return fp_valid();" method="post" action="fpc_backend.php" autocomplete="off">
                        ...
                        <div class="reg_link">
                            <span class="s_text color_white" >Want to Login?</span> <a href="loginCustomer.php" class="s_text color_green">Login Here</a>
                           </div>
